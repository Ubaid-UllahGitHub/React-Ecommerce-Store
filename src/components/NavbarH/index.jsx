            ...
            <Box sx={{
                ...
                <Container maxWidth="lg" sx={{ padding: "0px" }}>
                    <Grid container alignItems="center">
                        ...
                        <Grid item xs={12} md={4} sx={{ display: "flex", alignItems: "center", justifyContent: "flex-end", gap: "10px" }}>
                            ...
                            <Typography sx={{color: "#213547", fontFamily:"'League Spartan', sans-serif", fontSize: "13px"}}>
                                View Cart
                            </Typography>
                            <IconButton aria-label="Wish List" sx={{
                                padding: 0, 
                                "&:hover":{
                                    background: "transparent"
                                }
                            ...
                            <IconButton aria-label="User Login" sx={{
                                padding: 0, 
                                "&:hover":{
                                    background: "transparent"
                                }
                                    ...
                                    <ListItem
                                        ...
                                        sx={{
                                            ...
                                            "&::after": {
                                                ...
                                                width: "0%",
                                                height: "2px",
                                                backgroundColor: "#213547", // Line color
                                                bottom: "0",
                                                rigt: "10",
